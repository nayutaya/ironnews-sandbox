...
class MlpClassifier
  ...
  def backpropagation(input_values, target_values)
    ...
    self.update_input_hidden_weight(hidden_delta, input_values, @weight)
    self.update_output_hidden_weight(output_delta, hidden_values, @weight)
